  ...
  <v-container fluid>
    ...
    <div class="mt-5">
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Pain in the left anus; '"
      >
        anal pain
      </v-btn>
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Acute anal fissure ; '"
      >
        Anal abscess
      </v-btn>
      ...
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Anal fistula; '"
      >
        Anorectal abscess
      </v-btn>
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Anorectal fistula; '"
      >
        Anorectal fistula
      </v-btn>
