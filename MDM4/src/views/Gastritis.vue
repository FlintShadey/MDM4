  ...
  <v-container fluid>
    ...
    <div class="mt-5">
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Acute gastritis without bleeding '"
      >
      ...
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Acute gastritis with bleeding; '"
      >
      ...
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += ' Duodenitis without bleeding; '"
      >
        Duodenitis
      </v-btn>
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Gastroduodenitis, unspecified, without bleeding;  '"
      >
        Gastroduodenitis
      </v-btn>
      <v-btn
      ...
      <v-btn
        ...
        @click="
          secondaryValue +=
            '    Acute gastritis without bleeding Generalized abdominal pain; Nausea;  Nausea with vomiting, unspecified;  '
        "
      >
        everything gastritis
      </v-btn>
