<template>
  <v-container fluid>
    ...
    <div class="mt-5">
        ...
        color="#665251"
        class="ma-2"
        @click="secondaryValue += 'Acute cough; '"
      >
        Acute
      </v-btn>
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Subacute cough; '"
      >
        3-8 weeks
      </v-btn>
         <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Chronic cough; '"
      >
        > 8 weeks
      </v-btn>
      <v-btn color="#72728a" class="ma-2" @click="secondaryValue += 'Cough syncope ; '">
        syncope
      </v-btn>
      ...
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Other specified cough; '"
      >
        psychogenic
      </v-btn>
...
export default {
  ...
  data() {
    return {
      ...
      primaryValue:
        "The patient presents with coughing.\n\nThe patient is not currently hypoxic.\n\nThe patient does not have any current hemoptysis.\n\nThe patient does not have a history of immunocompromise, nor is there a toxic appearance.\n\nThe patient is euvolemic with no trismus, no airway compromise, and is able to tolerate oral hydration.\n\nThe patient will be safe for discharge and outpatient management.",
