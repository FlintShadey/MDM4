  ...
  <v-container fluid>
    ...
    <div class="mt-5">
      ...
      <v-btn
        color="#665251"
        class="ma-2"
        @click="secondaryValue += 'Acute ear pain; '"
      >
        acute ear pain
      </v-btn>
      <v-btn
        color="#72728a"
        class="ma-2"
        @click="secondaryValue += 'Otalgia with possible foreign body; '"
      >
        otalgia with possible foreign body
      </v-btn>
      <v-btn
        color="#665251"
        class="ma-2"
        @click="secondaryValue += 'Rule-out tympanic membrane rupture; '"
      >
