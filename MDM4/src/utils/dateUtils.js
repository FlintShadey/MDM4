...
export function generateWorkExcuse(daysToAdd) {
    ...
    return `The patient has been under my care and is excused from work or school from today's date: ${formattedStartDate} until ${formattedEndDate}. At which time they are cleared without restrictions`;
}
